...
uint256 hashGenesisBlock("0x75fb7a95f2a3a40719c9d5ae858665a21ed941483cf68af0d8c49d3dd1229d06");
...
const string strMessageMagic = "LeonCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // LeonCoin: 0.5 days
static const int64 nTargetSpacing = 150; // LeonCoin: 150 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal leoncoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LeonCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7e807ce975a4f1b0b5b2bf918136a6f1354e14ead737bf0b1c38998e90557aca");
    }
	...
	// Genesis block:
	// block.nTime = 1512949203 
	// block.nNonce = 386537001 
	// block.GetHash = 7e807ce975a4f1b0b5b2bf918136a6f1354e14ead737bf0b1c38998e90557aca 
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Starting 11-12-17.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1512959522;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386596544;
        ...
        assert(block.hashMerkleRoot == uint256("0x73d1dae79fb28a0896ac323491a22f54b2b00d73ba0a1988e7362ca9952acfaf"));
